                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            <a class="btn text-white btn-primary" href="{{ route('dispensasi_nikah.create') }}">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header row">
                            <h5 class="col">Tabel Dispensasi Nikah</h5>
...
@section('js-extends')
    <script src="{{ asset('js/dispensasi_nikah/index.js') }}"></script>
@endsection