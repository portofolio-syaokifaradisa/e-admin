                ...
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            <a class="btn text-white btn-primary" href="{{ route('service.create') }}">
...
@section('js-extends')
    <script src="{{ asset('js/layanan/index.js') }}"></script>
@endsection