                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <div class="d-inline">
                            ...
                            <span>Laporan data-data kependudukan desa/kelurahan yang tercatat</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header row">
                            <h5 class="col">Laporan Kependudukan</h5>
...
@section('js-extends')
    <script src="{{ asset('js/report/kependudukan.js') }}"></script>
@endsection