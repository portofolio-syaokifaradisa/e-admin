@extends('templates.app', ['title' => 'Manajemen Absensi Pegawai'])
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>Manajemen Absensi Pegawai</h4>
                            <span>Memanajemen data-data absensi pegawai</span>
                        </div>
                    </div>
                </div>
            </div>
...
@section('js-extends')
    <script src="{{ asset('js/kehadiran/index.js') }}"></script>
@endsection