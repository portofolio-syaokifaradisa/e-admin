                    ...
                    return `
                        <div class="btn-group dropright px-0 pr-2">
                            ...
                            <div class="dropdown-menu dropright">
                                <a class="dropdown-item has-icon" href="${window.location.href}/${dispensasi_nikah.id}/rekomendasi">
    ...
    $('#datatable').on('draw.dt', function (datatable) {
        ...
        for(let deleteButton of deleteButtons){
            deleteButton.addEventListener('click', function(e){
                ...
                confirmAlert(
                    "Konfirmasi Penghapusan Data Dispensasi Nikah",
                    "Apakah Anda Yakin ingin Menghapus Catatan Dispensasi Nikah?",
                    async function(){
